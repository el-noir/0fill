            ...
            <div className="bg-[#1C1C24] rounded-2xl p-10 shadow-xl border border-white/10 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  GitHub
                  <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-[10px] bg-gray-800 text-gray-300 px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Coming Soon</span>
                </button>
              </div>
